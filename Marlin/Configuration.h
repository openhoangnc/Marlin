...
#define STRING_CONFIG_H_AUTHOR "(hoangnc, Ender-3 Pro)" // Who made the changes.
...
#define BUSY_WHILE_HEATING         0  // Some hosts require "busy" messages even during heating
